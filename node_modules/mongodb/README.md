...
---------------------
Let's create a new **app1.js** file that we will use to show the basic CRUD operations using the MongoDB driver.
...
We can now run the update **app1.js** file.

```
node app1.js
```

You should see the following output after running the **app1.js** file.
